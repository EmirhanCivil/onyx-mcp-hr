...
- `url` / `public_url` — `http://localhost:8007/...` (bunu ver)
...
### 🖼️ Görsel & 📄 Rapor
Üretilen dosyaları `http://localhost:8007/...` URL'iyle ver. Markdown image (grafik) veya markdown link (rapor). Her görselin altına 1 cümlelik **okuma rehberi**.
